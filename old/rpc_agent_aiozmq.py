...
class FreelanceClient(object):
    ...
    async def create_requester(self):
        requester = await aiozmq.create_zmq_stream(zmq.DEALER, connect="inproc://toto")
...
class FreelanceAgent(object):
    ...
    def __init__(self, context, command_frontend):
        ...
        self.request_socket = aiozmq.create_zmq_stream(zmq.ROUTER, bind="inproc://toto")
